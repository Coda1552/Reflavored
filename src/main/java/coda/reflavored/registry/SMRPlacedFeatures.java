...
public class SMRPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> PATCH_BUTTERCUP = PLACED_FEATURES.register("patch_buttercup", () -> new PlacedFeature(SMRConfiguredFeatures.BUTTERCUP.getHolder().get(), List.of(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
}