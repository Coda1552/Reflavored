...
import coda.reflavored.registry.SMRConfiguredFeatures;
import coda.reflavored.registry.SMRPlacedFeatures;
...
public class SMRBiomeModifier implements BiomeModifier {
    ...
    public void modify(Holder<Biome> biome, Phase phase, ModifiableBiomeInfo.BiomeInfo.Builder builder) {
        ...
        //        builder.getGenerationSettings().addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SMRPlacedFeatures.PATCH_ALPINE_LILY);
        //    }
        //    if (biome.is(SMRTags.HAS_DOUGLAS_IRIS)) {
        //        builder.getGenerationSettings().addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SMRConfiguredFeatures.PATCH_DOUGLAS_IRIS);
        //    }
        //}
    }
